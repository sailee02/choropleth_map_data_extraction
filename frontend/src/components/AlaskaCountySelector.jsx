...
// Suggested counties for 4-point alignment in Alaska
// Using large, well-distributed counties for better alignment
const SUGGESTED_COUNTIES = [
  { name: "North Slope Borough, Alaska", geoid: "02185", region: "North", description: "Click on North Slope Borough, AK (northernmost region - large area)" },
  { name: "Yukon-Koyukuk Census Area, Alaska", geoid: "02290", region: "Central-East", description: "Click on Yukon-Koyukuk Census Area, AK (central-east, largest county)" },
  { name: "Lake and Peninsula Borough, Alaska", geoid: "02164", region: "Southwest", description: "Click on Lake and Peninsula Borough, AK (southwest region - better western distribution)" },
  { name: "Ketchikan Gateway Borough, Alaska", geoid: "02130", region: "Southeast", description: "Click on Ketchikan Gateway Borough, AK (southeast panhandle)" }
];
    ...
    <div style={{
      ...
      <div style={{
        ...
        <h3 style={{
          ...
          Align Alaska Shapefile - Select 4 Counties
        </h3>
